...
namespace PackageExpressAssignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (pkgWeight > 50)
            {
                Console.WriteLine("We're sorry, that package is unable to be shipped through us. Have a nice day.");
            };
            ...
            string pkgDecision = (pkgTotalDim > 50) ? "We're sorry, that package is unable to be shipped through us. Have a nice day." : "The cost for shipping this package will be: $" + pkgCost + ".00.";
            Console.WriteLine(pkgDecision);
